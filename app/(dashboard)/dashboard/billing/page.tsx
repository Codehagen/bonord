...
export const metadata = {
  title: "Propwrite Billing - Subscription Management",
  description:
    "Access and manage your billing information, view subscription plans, and update payment methods on Propwrite's Billing page.",
};
